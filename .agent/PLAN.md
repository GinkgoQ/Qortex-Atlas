...
- [ ] Implement missing or shallow Qortex domain/API functionality. Completed slices: model zoo/typed execution profiles/public segmentation and object-detection inference/recoverable model-cache controls, executable local-label/split readiness, demographics, observed plus explicit-design coverage, validation, persistent fMRI QC/scrub-plan/mean-volume export, sensor and public MNI ROI connectivity/ROI browser, signal features, inferential cohort comparison, cache inventory, conversion/export.
...
- [x] Run focused unit, integration, browser, public-dataset, and public-model checks for every landed slice. Aggregate focused suite: 117 passed before the detection slice; detection/model-catalog focus: 26 passed; latest combined model/cache/cohort/fMRI slice: 16 passed; readiness/check regression slice: 32 passed; public ROI/readiness/fMRI integration slice: 6 passed. Live ds000001/ds000117, development-fMRI/Schaefer-100, MONAI/BraTS, Faster R-CNN/COCO, conversion, validator, telemetry, persistent fMRI artifacts, and Chrome workflows verified.
